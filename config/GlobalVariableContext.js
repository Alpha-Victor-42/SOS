...
const DeviceVariables = {
  Directus_user_role: '',
  Directus_user_token: 'KeCg3qna7L88cL6pK5W29fgVvMzbwzzpJkZfB4m2aE',
  Directus_victor_access_token: 'KeCg3qna7L88cL6pK5W29fgVvMzbwzzpJkZfB4m2aE',
  pageSelectedToggle: '',
  pageToggles: '',
  selectedBesoin: 'test',
};
const AppVariables = {
  ...
  month: 0,
  searchable_besoin: '',
  searchable_location: 'Saint Nazaire',
  searchable_thematique: '',
  searchable_topic: '',
  selectedDate: '',
  successModal: false,
  year: 2022,
